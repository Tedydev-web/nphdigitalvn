					...
					<div className="row">
						<div className="col-xxl-12">
							<div className="sec-title-wrapper">
								<h2 className="sec-title title-anim">{t('chamSocFanpage.FanpageService.secTitle')}</h2>
							</div>
						</div>
						...
						<div className="col-xxl-9 col-xl-9 col-lg-9 col-md-9">
							...
							<div className="service__detail-content">
								<p>{t('chamSocFanpage.FanpageService.p.1')}</p>
								<p>{t('chamSocFanpage.FanpageService.p.2')}</p>
							</div>
						</div>
					</div>
				</div>
