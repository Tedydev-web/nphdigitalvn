						...
						<div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
							<div className="sec-title-wrapper">
								<h2
									...
									ref={charAnim}>
									<span>{t('crmErpHrm.DetailsSystem.secTitle.line1')}</span> <br />
									<span>{t('crmErpHrm.DetailsSystem.secTitle.line2')}</span>
								</h2>
							</div>
						</div>
						<div className="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
							<div className="development__wrapper">
								<div className="development__content">
									<p>{t('crmErpHrm.DetailsSystem.p.1')}</p>
									<p>{t('crmErpHrm.DetailsSystem.p.2')}</p>
								</div>
								<ul>
									<li>{t('crmErpHrm.DetailsSystem.ul.1.li.1')}</li>
									<li>{t('crmErpHrm.DetailsSystem.ul.1.li.2')}</li>
									<li>{t('crmErpHrm.DetailsSystem.ul.1.li.3')}</li>
									<li>{t('crmErpHrm.DetailsSystem.ul.1.li.4')}</li>
