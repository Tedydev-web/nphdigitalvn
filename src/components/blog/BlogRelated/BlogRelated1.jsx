	...
	const blogs = [
		{
			...
			category: t('StartupAgencyBlog.blogs.blog9.category', { ns: 'blog' }),
			date: t('StartupAgencyBlog.blogs.blog9.date', { ns: 'blog' }),
			title: t('StartupAgencyBlog.blogs.blog9.title', { ns: 'blog' }),
			excerpt: t('StartupAgencyBlog.blogs.blog9.excerpt', { ns: 'blog' }),
		},
		{
			src: Blog2,
			href: '/chi-tiet-bai-viet-2',
			category: t('StartupAgencyBlog.blogs.blog10.category', { ns: 'blog' }),
			date: t('StartupAgencyBlog.blogs.blog10.date', { ns: 'blog' }),
			title: t('StartupAgencyBlog.blogs.blog10.title', { ns: 'blog' }),
			excerpt: t('StartupAgencyBlog.blogs.blog10.excerpt', { ns: 'blog' }),
		},
		{
			src: Blog3,
			href: '/chi-tiet-bai-viet-3',
			category: t('StartupAgencyBlog.blogs.blog11.category', { ns: 'blog' }),
			date: t('StartupAgencyBlog.blogs.blog11.date', { ns: 'blog' }),
			title: t('StartupAgencyBlog.blogs.blog11.title', { ns: 'blog' }),
			excerpt: t('StartupAgencyBlog.blogs.blog11.excerpt', { ns: 'blog' }),
		},
	];
